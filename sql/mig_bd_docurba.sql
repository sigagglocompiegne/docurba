...
-- 
-- DROP MATERIALIZED VIEW IF EXISTS x_apps.x_apps_an_vmr_fichegeo_ruplu1_gdpublic;
-- 
-- CREATE MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu1_gdpublic AS 
--  WITH req_par AS (
...
--                     ELSE NULL::text
--                 END AS plu_1
--            FROM m_urbanisme_doc_cnig.an_doc_urba,
...
-- Materialized View: x_apps.x_apps_an_vmr_fichegeo_ruplu21_gdpublic
-- 
-- DROP MATERIALIZED VIEW IF EXISTS x_apps.x_apps_an_vmr_fichegeo_ruplu21_gdpublic;
-- 
-- CREATE MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu21_gdpublic AS 
--  WITH req_par AS (
--          SELECT "substring"(parcelle.parcelle, 5, 15) AS idu,
--             '60'::text || "substring"(parcelle.parcelle, 8, 15) AS parcelle,
--             '60'::text || parcelle.ccocom AS insee
...
-- WITH DATA;
-- 
-- ALTER TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu21_gdpublic
--   OWNER TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu21_gdpublic TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu21_gdpublic TO groupe_sig;
-- COMMENT ON MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu21_gdpublic
...
-- Materialized View: x_apps.x_apps_n_vmr_fichegeo_ruplu3_gdpublic
-- 
-- DROP MATERIALIZED VIEW IF EXISTS x_apps.x_apps_an_vmr_fichegeo_ruplu3_gdpublic;
-- 
-- CREATE MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu3_gdpublic AS 
--  WITH req_par AS (
--          SELECT "substring"(parcelle.parcelle, 5, 15) AS idu,
--             '60'::text || "substring"(parcelle.parcelle, 8, 15) AS parcelle,
--             '60'::text || parcelle.ccocom AS insee
...
-- WITH DATA;
-- 
-- ALTER TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu3_gdpublic
--   OWNER TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu3_gdpublic TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu3_gdpublic TO groupe_sig;
-- COMMENT ON MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu3_gdpublic
...
-- 
-- DROP MATERIALIZED VIEW IF EXISTS x_apps.x_apps_an_vmr_fichegeo_ruplu4_gdpublic;
-- 
-- CREATE MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu4_gdpublic AS 
--  WITH req_par AS (
--          SELECT "substring"(parcelle.parcelle, 5, 15) AS idu,
--             '60'::text || "substring"(parcelle.parcelle, 8, 15) AS parcelle,
--             '60'::text || parcelle.ccocom AS insee
...
-- WITH DATA;
-- 
-- ALTER TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu4_gdpublic
--   OWNER TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu4_gdpublic TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu4_gdpublic TO groupe_sig;
-- COMMENT ON MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu4_gdpublic
...
-- Materialized View: x_apps.x_apps_an_vmr_fichegeo_ruplu5_gdpublic
-- 
-- DROP MATERIALIZED VIEW IF EXISTS x_apps.x_apps_an_vmr_fichegeo_ruplu5_gdpublic;
-- 
-- CREATE MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu5_gdpublic AS 
--  WITH req_par AS (
--          SELECT "substring"(parcelle.parcelle, 5, 15) AS idu,
--             '60'::text || "substring"(parcelle.parcelle, 8, 15) AS parcelle,
--             '60'::text || parcelle.ccocom AS insee
...
-- WITH DATA;
-- 
-- ALTER TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu5_gdpublic
--   OWNER TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu5_gdpublic TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu5_gdpublic TO groupe_sig;
-- COMMENT ON MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu5_gdpublic
...
-- DROP MATERIALIZED VIEW IF EXISTS x_apps.x_apps_an_vmr_parcelle_plu;
-- 
-- CREATE MATERIALIZED VIEW x_apps.x_apps_an_vmr_parcelle_plu AS 
--  WITH req_par AS (
...
-- WITH DATA;
-- 
-- ALTER TABLE x_apps.an_vmr_parcelle_plu
--   OWNER TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_parcelle_plu TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_parcelle_plu TO groupe_sig;
-- COMMENT ON MATERIALIZED VIEW x_apps.x_apps_an_vmr_parcelle_plu
...
-- 
-- CREATE MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu2_gdpublic AS 
--  WITH req_par AS (
--          SELECT "substring"(parcelle.parcelle, 5, 15) AS idu,
--             '60'::text || "substring"(parcelle.parcelle, 8, 15) AS parcelle,
--             '60'::text || parcelle.ccocom AS insee
...
--            FROM r_cadastre.geo_parcelle
--              LEFT JOIN m_urbanisme_doc.an_vmr_parcelle_plu ON ('60'::text || geo_parcelle.idu) = an_vmr_parcelle_plu.idu
...
-- WITH DATA;
-- 
-- ALTER TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu2_gdpublic
--   OWNER TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu2_gdpublic TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_an_vmr_fichegeo_ruplu2_gdpublic TO groupe_sig;
-- COMMENT ON MATERIALIZED VIEW x_apps.x_apps_an_vmr_fichegeo_ruplu2_gdpublic
...
-- Materialized View: x_apps.x_apps_geo_vmr_p_zone_urba
-- 
-- DROP MATERIALIZED VIEW IF EXISTS x_apps.x_apps_geo_vmr_p_zone_urba;
-- 
-- CREATE MATERIALIZED VIEW x_apps.x_apps_geo_vmr_p_zone_urba AS 
--  SELECT geo_p_zone_urba.idzone,
--     geo_p_zone_urba.libelle,
--     geo_p_zone_urba.libelong,
--     geo_p_zone_urba.typezone,
...
-- WITH DATA;
-- 
-- ALTER TABLE x_apps.x_apps_geo_vmr_p_zone_urba
--   OWNER TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_geo_vmr_p_zone_urba TO postgres;
-- GRANT ALL ON TABLE x_apps.x_apps_geo_vmr_p_zone_urba TO groupe_sig;
-- COMMENT ON MATERIALIZED VIEW x_apps.x_apps_geo_vmr_p_zone_urba
